          ...
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 sm:p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                >
                  <Mail className="w-5 sm:w-6 h-5 sm:h-6 text-red-400 hover:text-yellow-400 transition-colors" />
                </a>
              ...
              <div className="flex items-center space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 sm:w-12 h-10 sm:h-12 bg-blue-400/20 hover:bg-green-500/20 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300 transform hover:scale-110 group"
                >
                  <Phone className="w-5 sm:w-6 h-5 sm:h-6 text-blue-400 group-hover:text-green-500 transition-colors" />
                </a>
                <div>
              ...
              <div className="flex items-center space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 sm:w-12 h-10 sm:h-12 bg-purple-400/20 hover:bg-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300 transform hover:scale-110 group"
                >
                  <MapPin className="w-5 sm:w-6 h-5 sm:h-6 text-purple-400 group-hover:text-red-500 transition-colors" />
                </a>
                <div>
                  <p className="text-gray-400 text-sm">Localização</p>
                  <p className="text-white font-semibold text-sm sm:text-base">
                    Rua: Francisco Barbosa Xavier, 38{" "}
                  </p>
                  <p className="text-white font-semibold text-sm sm:text-base">
                    Bairro: São Domingos
                  </p>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-gray-600/20 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
                  title="GitHub"
                >
                  <Github className="w-5 h-5 text-white group-hover:text-gray-300 transition-colors" />
                </a>
                <a
                  href="http://www.linkedin.com/in/marcelo-tubarao"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-blue-400/20 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
                  title="LinkedIn"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-green-500/20 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
                  title="WhatsApp"
                >
